...
WHERE s.tgt_table_name = 'dimpolicycampaign' AND s.tgt_source_app_code = 'EBLI';
...
WHERE tgt_table = 'dimpolicycampaign' and entity in (select source_data_Set from #tgt_count);
