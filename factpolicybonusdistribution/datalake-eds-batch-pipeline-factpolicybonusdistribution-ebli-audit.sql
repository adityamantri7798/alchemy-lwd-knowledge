...
from
  el_eds_def.factpolicybonusdistribution
where
...
WHERE s.tgt_table_name = 'factpolicybonusdistribution' AND s.tgt_source_app_code = 'EBLI';
...
WHERE tgt_table = 'factpolicybonusdistribution' and entity in (select source_data_set from #tgt_count);
