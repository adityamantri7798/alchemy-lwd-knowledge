...
UPDATEel_eds_def_stg.dq_audit_stg
SET matched_records = b.target_count
FROMel_eds_def_stg.dq_audit_stg a 
...
INSERT INTOel_eds_def_stg.ctrl_audit (
...
FROMel_eds_def_stg.ctrl_audit_stg s
INNER JOIN #tgt_count t ON s.tgt_source_data_set = t.source_data_set
WHERE s.tgt_table_name = 'factpolicypayout' AND s.tgt_source_app_code = 'EBLI';


INSERT INTOel_eds_def_stg.dq_audit (
...
FROMel_eds_def_stg.dq_audit_stg 
WHERE tgt_table = 'factpolicypayout';


DROP TABLE #tgt_count;
END;